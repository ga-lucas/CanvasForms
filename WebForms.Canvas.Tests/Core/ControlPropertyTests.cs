...
public class ControlPropertyFunctionalityTests
{
    ...
    public void LayoutProperties_ShouldBeFunctional()
    {
        ...
        control.Location = new System.Drawing.Point(5, 15);
        ...
        // Bounds
        control.Bounds = new System.Drawing.Rectangle(0, 0, 300, 150);
        Assert.Equal(0, control.Left);
        Assert.Equal(0, control.Top);
...
#pragma warning restore CS0618
    ...
    public void StaticInputProperties_AreCompatibilityOnly()
    {
        ...
        Assert.Equal(System.Drawing.Point.Empty, Control.MousePosition);
