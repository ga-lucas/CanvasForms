...
public abstract class Control
{
    ...
    /// <summary>Default WndProc pass-through — no-op in canvas environment.</summary>
    protected void DefWndProc(ref Message m) { }

    /// <summary>Pre-processes a message before dispatch — always returns false.</summary>
    public virtual bool PreProcessMessage(ref Message msg) => false;

    /// <summary>Pre-processes a control message — always returns false.</summary>
