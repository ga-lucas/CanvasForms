...
{
    internal readonly ToolStripButton _inner;
    ...
    /// <see cref="ToolBarButtonStyle.Separator"/> is rendered as a <see cref="ToolStripSeparator"/>.
    /// </summary>
    ...
    /// <summary>The dropdown menu shown when <see cref="Style"/> is <see cref="ToolBarButtonStyle.DropDownButton"/>.</summary>
...
public class ToolBar : Control
{
    ...
    public ToolBar()
    {
        ...
        _strip.ItemClicked += (s, e) =>
        {
            ...
            var btn = _buttons.FindByInner(e.ClickedItem as ToolStripButton);
            if (btn != null)
    ...
    /// The ToolStrip paints itself into the same canvas area.
    /// </summary>
    ...
    public sealed class ToolBarButtonCollection : IEnumerable<ToolBarButton>
    {
        ...
        internal ToolBarButton? FindByInner(ToolStripButton? inner)
        {
            if (inner == null) return null;
            return _items.FirstOrDefault(b => b._inner == inner);
        }
